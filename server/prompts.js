...
export const MADLIBS_PROMPTS = [
  {
    ...
    twist: "BREAKING NEWS: {NAME} was last seen happiest when {0}. Witnesses report {NAME} seemed most proud when {1}. Police are baffled.",
  },
  {
    id: "ml2",
    category: "wholesome",
    ...
    twist: "Inside {NAME}'s cult, the daily schedule is simple: spend the morning {0}, then end the night {1}. Recruitment is now open.",
  },
  {
    id: "ml3",
    category: "wholesome",
    ...
    blanks: ["always…", "never…"],
    twist: "The jury found {NAME} guilty: they always {0}, and the court noted {NAME} would never {1}. Sentencing is pending.",
  },
  {
    id: "ml4",
    category: "wholesome",
    ...
    twist: "Inspectors raided {NAME}'s bunker: a room just for {0}, and a backyard perfect for {1}. Authorities are 'concerned.'",
  },
  {
    id: "ml5",
    category: "wholesome",
    ...
    twist: "{NAME}'s breakup text read: 'You were always the first to {0}. Honestly, you helped me {1}. We're done.'",
  },
  {
    id: "ml6",
    category: "wholesome",
    ...
    twist: "{NAME}'s wanted poster reads: 'Surprisingly good at {0}, often seen doing it while {1}. Approach with caution.'",
  },
  {
    id: "ml7",
    category: "wholesome",
    ...
    twist: "Health inspectors shut down {NAME}'s restaurant: 'Always brings {0} to the table, leaving every customer feeling {1}.' Closed indefinitely.",
  },
  {
    id: "ml8",
    category: "wholesome",
    ...
    twist: "Customs stopped {NAME}: 'So you couldn't wait to try {0}, and you've packed way too much {1}?' Step into the side room, please.",
  },
  {
    id: "ml9",
    category: "wholesome",
    ...
    twist: "{NAME}'s ghost has unfinished business: every night it returns to start the day with {0}, and a little bit of {1}. It cannot move on.",
  },
  {
    id: "ml10",
    category: "wholesome",
    ...
    twist: "{NAME}'s villain manifesto: 'I show the world I care by {0}. I will only feel truly loved when humanity {1}.'",
  },
  {
    id: "ml11",
    category: "wholesome",
    ...
    twist: "Tabloid headline: '{NAME}, disgraced ex-{0}, EXPOSED — sources confirm they were always amazing at {1}!' More at 11.",
  },
  {
    id: "ml12",
    category: "wholesome",
    ...
    twist: "The detective read {NAME}'s diary aloud: 'Spent the day {0}. Finished the night by {1}.' The room went silent.",
  },
];
